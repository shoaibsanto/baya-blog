...
export function ChatWidget() {
  ...
  // Generated after mount (not inline in the initializer) — computing a random ID
  // during render would make the component non-idempotent under Strict Mode's
  // double-invoke. sendMessage only ever runs after a user interaction, well after
  // this effect has run, so the ref is always populated by the time it's read.
