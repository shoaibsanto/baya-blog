...
4. প্রাসঙ্গিক পোস্ট উল্লেখ করলে অবশ্যই তার লিংক (পুরো https://baya.blog/... URL) সরাসরি টেক্সটে দাও।
...
7. শুধু প্লেইন টেক্সট লিখবে — কোনো markdown ফরম্যাটিং ব্যবহার করবে না (কোনো **bold**, *italic*, [লিংক টেক্সট](url) স্টাইল, বা # heading নয়)। বুলেট পয়েন্টের জন্য শুধু "-" ব্যবহার করতে পারো, লিংক দিতে হলে পুরো URL সরাসরি লিখবে।
